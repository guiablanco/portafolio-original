...
//images
import styledIA from '../../assets/images/styled-IA.png';
    ...
    return (
        <div>
            <Card className='card1' style={{margin:'1rem', width:'18rem', height: !expanded ? '35rem': '60rem'}} sx={{ maxWidth: 345 }}>
                    <CardHeader
                        avatar={
                        <Avatar style={{cursor:'pointer'}} sx={{ bgcolor: purple[800] }} aria-label="recipe">
                            AI
                        </Avatar>
                        }
                    ...
                    <CardContent>
                        ...
                        (Actualmente en mantenimiento) Si buscas añadirle estilo a una de tus imágenes usando Inteligencia Artificial, este proyecto te ayudará. Solo disponible hasta el 9 de Noviembre. 
                        </Typography>
                    </CardContent>
